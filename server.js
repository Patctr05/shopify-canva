    ...
    if (data && data.products && data.products.length > 0) {
      ...
      mockCollections.mens_tshirts = {
        ...
        products: mapped.filter(p => {
          ...
          const isTShirt = title.includes('t-shirt') || title.includes('tee');
          const isWomen = title.includes('woman') || title.includes('women') || title.includes('women’s') || title.includes('woman’s');
